...
This repository features a range of personal projects I’ve completed while working toward becoming a Junior Data Analyst.
...
* **Tools:** Jupyter Notebook, API integration, CSV/Excel processing
...
These analytics projects are concentrated on:
* **Exploratory Data Analysis (EDA):** Data cleaning, pattern discovery, and insight visualization.
* **A/B Testing:** Statistical hypothesis testing and results interpretation.
* **Product Metrics:** Calculating key business metrics (LTV, CAC, Retention, Churn).
* **Automation:** Scripts for automated data collection or processing.
